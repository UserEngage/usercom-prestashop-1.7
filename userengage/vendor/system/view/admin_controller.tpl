        ...
        <div class="panel col-xs-offset-4 col-xs-4 col-md-offset-0 col-md-12">
            ...
            <div class="panel-content">
                {if $isUpdateAvailable}
                    <p class="text-center">{l s='Version' mod='pshowsystem'}: <strong class="label label-danger">{$moduleVersion}</strong></p>
                    <p class="text-center"><strong class="label label-danger">New version available!</strong><hr></p>
                {else}
                    <p class="text-center">{l s='Version' mod='pshowsystem'}: <strong class="label label-success">{$moduleVersion}</strong></p>
                    {/if}
                ...
                <p>
                    ...
                    {if version_compare($smarty.const.LIBXML_DOTTED_VERSION, '2.9.3') == 0}
                        <span title="" data-toggle="tooltip" class="pull-right label label-tooltip label-danger"
                              data-original-title="{l s='This version of PHP extension may cause problems in the operation of modules related to XML processing.' mod='pshowsystem'}" data-html="true" data-placement="top">
